...
class WhereIsSafe:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Where Is Safe')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'WhereIsSafe')
        self.toolbar.setObjectName(u'WhereIsSafe')

        #print "** INITIALIZING WhereIsSafe"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('WhereIsSafe', message)
    ...
    def unload(self):
        ...
        #print "** UNLOAD WhereIsSafe"

        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Where Is Safe'),
                action)
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = WhereIsSafeDockWidget(self.iface)
